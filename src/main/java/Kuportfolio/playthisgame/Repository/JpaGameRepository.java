...
public class JpaGameRepository implements GameRepository{
    ...
    public long CountBetween(GameDTO dto) {
        return (long) entityManager.createQuery("select count (g) from Game g where g.casual between : casual and (: casual + 1) and g.challenge between :challenge and (: challenge +1)" +
    ...
    public long CountBetweenWide(GameDTO dto) {
        return (long) entityManager.createQuery("select count (g) from Game g where g.casual between (: casual -1) and (: casual + 1) and g.challenge between (:challenge -1) and (: challenge +1)" +
    ...
    public long CountBetweenWide2(GameDTO dto) {
        return (long) entityManager.createQuery("select count (g) from Game g where g.casual between (: casual -1) and (: casual + 2) and g.challenge between (:challenge -1) and (: challenge + 2)" +
